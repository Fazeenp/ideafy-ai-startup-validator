...
export default function MarketCompetition({ data }) {
  return (
    <div>
      {/* Title */}
      <h2 className="text-3xl font-bold mb-6">Market & Competition Analysis</h2>
      ...
      {/* Market Landscape */}
      <section className="mb-8">
        <h3 className="text-xl font-semibold mb-4">Market Landscape</h3>
        <div className="grid grid-cols-2 gap-6">
          {/* Market Share Chart */}
          <div className="bg-white/10 p-4 rounded-xl">
            <h4 className="font-semibold mb-2">Market Share Distribution</h4>
            <PieChartComponent
              data={data.stats || [
        ...
        <div className="grid grid-cols-3 gap-4">
          {(data.competitors || [
            ...
            <div key={idx} className="bg-white/10 p-4 rounded-xl">
              ...
              <p className="text-sm text-neutral-400">{comp.detail}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="mb-8">
        <h3 className="text-xl font-semibold mb-2">Competitive Advantage Radar</h3>
        <RadarChartComponent
          data={data.radar || [
